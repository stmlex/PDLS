...
/*  Date (dd.mm.yyyy): 16.12.2023   Time (hh:mm): 18:52                        */
/*******************************************************************************/


#define GUIX_STUDIO_GENERATED_FILE
#include <stddef.h>
#include "pdls_resources.h"
#include "pdls_specifications.h"

static GX_WIDGET *gx_studio_nested_widget_create(GX_BYTE *control, GX_CONST GX_STUDIO_WIDGET *definition, GX_WIDGET *parent);
SCRMAIN_CONTROL_BLOCK scrMain;
...
GX_STUDIO_DISPLAY_INFO pdls_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_WINDOW_PROPERTIES scrMain_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
GX_LINE_CHART_INFO scrMain_line_chart_properties =
{
    0,                                       /* min data value                 */
    100,                                     /* max data value                 */
...
GX_CONST GX_STUDIO_WIDGET scrMain_line_chart_define =
{
    "line_chart",
    ...
    offsetof(SCRMAIN_CONTROL_BLOCK, scrMain_line_chart), /* control block      */
    (void *) &scrMain_line_chart_properties  /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET scrMain_define =
{
    "scrMain",
    ...
    GX_STATUS_ACCEPTS_FOCUS,                 /* status flags                   */
    sizeof(SCRMAIN_CONTROL_BLOCK),           /* control block size             */
    GX_COLOR_ID_WINDOW_FILL,                 /* normal color id                */
    GX_COLOR_ID_WINDOW_FILL,                 /* selected color id              */
    GX_COLOR_ID_DISABLED_FILL,               /* disabled color id              */
    ...
    GX_NULL,                                 /* next widget                    */
    &scrMain_line_chart_define,              /* child widget                   */
    0,                                       /* control block                  */
    (void *) &scrMain_properties             /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY pdls_widget_table[] =
{
    { &scrMain_define, (GX_WIDGET *) &scrMain },
    {GX_NULL, GX_NULL}
};
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = pdls_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &pdls_display_table[display];
